...
const CTISetup = () => {
  return (
    <CTILayout>
      <h1>Quick-Start Guide to Installing OpenWebUI</h1>
      ...
      <section>
        ...
        <p>
          We want to install Ollama and run it in a docker container. OpenWebUI utilizes Ollama to install and download new models. So we need Ollama running in a docker container for OpenWebUI. 
        </p>
        ...
        <p>
            ...
            already installed models locally in Ollama then they should appear in Open Web UI.
        </p>

        <h2>Step 2: Install and Launch OpenWebUI with new features</h2>
        <p>
            Next we will Install OpenWebUI and Launch it in Docker. Run the following line of code in a terminal window.
        </p>
        ...
        <p>
            If you use Docker Desktop you should be able to open the localhost url and see OpenWebUI running. Next step is to download a few models and test out the environment.
        </p>

      </section>

      <h1>Full Setup Guide for OpenWebUI</h1>
